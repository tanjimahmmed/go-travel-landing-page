  ...
  return (
    <div className='flex flex-col items-center justify-center px-24 py-64'>
        ...
        <div className='flex max-w-124 flex-col justify-center gap-y-2 text-center'>
            ...
            <p className='text-grey-900 text-base/8 font-light'>{props.children} Try re-loading the page or returning later. If the issue persist, please contact our tech team.</p>
        </div>
    </div>
  )
}
