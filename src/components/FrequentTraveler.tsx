        ...
        <div className='border-y-grey-500/40 m-auto flex max-w-389 items-center justify-between gap-x-28 border-y-1 py-26'>
            ...
            <form className='flex basis-150 flex-col'>
                <label className='mb-8'>
                    ...
                    <input required type="text" name='fullName' minLength={2} maxLength={50} placeholder='Jane Doe' className='placeholder:text-grey-400 w-full rounded-lg bg-white py-3.5 pl-4 transition-all duration-200 placeholder:font-light focus:outline-1 disabled:opacity-50' />
                </label>
                <label className='mb-12'>
                    <p className='tracking-6 mb-3 text-lg/9.5 font-semibold'>Email</p>
                    <input type="email" name='emailAddress' minLength={3} maxLength={50} placeholder='jane@gmail.com' className='placeholder:text-grey-400 w-full rounded-lg bg-white py-3.5 pl-4 transition-all duration-200 placeholder:font-light focus:outline-1 disabled:opacity-50' />
                </label>
