...
const Hero = () => {
  return (
    <section className='relative m-auto max-w-[108rem]'>
      <div className="relative flex items-center justify-center bg-[url('/public/hero.webp')] bg-cover bg-bottom pb-[56.25%]">
        <div className='absolute top-0 right-0 bottom-0 left-0 flex items-center justify-center text-center'>
          <div>
